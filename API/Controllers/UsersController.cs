...
public class UsersController(IUnitOfWork unitOfWork, IMapper mapper, IPhotoService photoService) : BaseApiController
{
    ...
    [HttpGet]
    public async Task<ActionResult<IEnumerable<DTOs.MemberDto>>> GetUsers([FromQuery] UserParams userParams)
    {
    ...
    public async Task<ActionResult> UpdateUser(MemberUpdateDto memberUpdateDto)
    {
        ...
        var user = await unitOfWork.UserRepository.GetUserByUsernameAysnc(User.GetUsername());
